...
$sql = "SELECT t.*, c.nome FROM tarefas_stories t 
...
<head>
    ...
    <title>Gerenciador de Tarefas de Vídeo</title>
...
<body>
    ...
    <div class="sidebar">
        ...
        <ul>
            ...
            <li>
               <button onclick="location.href='gerstories.php'">
               Tarefas Stories
                    <span class="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#e8eaed">
                            <path d="M480-80q-83 0-156-31.5T197-197q-54-54-85.5-127T80-480q0-83 31.5-156T197-763q54-54 127-85.5T480-880q65 0 123 19t107 53l-58 59q-38-24-81-37.5T480-800q-133 0-226.5 93.5T160-480q0 133 93.5 226.5T480-160q32 0 62-6t58-17l60 61q-41 20-86 31t-94 11Zm280-80v-120H640v-80h120v-120h80v120h120v80H840v120h-80ZM424-296 254-466l56-56 114 114 400-401 56 56-456 457Z"/>
            ...
            <li>
                <button  id="toggleApprovedBtn" onclick="location.href='upload.php'">
                    Upload
                    <span class="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#e8eaed">
    ...
    <div class="app-container">
        <h1>Gerenciador de Tarefas de stories</h1>
        ...
        <div class="kanban">
            <div class="column" id="todo">
                ...
                <div class="task-container" id="pendente">
                    <?php
                        foreach ($tarefas_stories as $key => $tarefa) {
                            if(strtolower($tarefa['status']) == 'pendente'){
                                echo "<div class='task' id='".$tarefa['id_tarefa_stories']."' draggable='true' ondragstart='dragStart(event)' ondragend='dragEnd(event)'>
                                        <ul>
                                            <li class='task-detail'>Cliente: {$tarefa['nome']}</li>
                                            <li class='task-detail'>{$tarefa['descricao']}</li>
                                            <li class='task-detail'>{$tarefa['data_hora']}</li>
                                        </ul>
                                        <button class='delete-btn' onclick='deletaTarefa(".$tarefa['id_tarefa_stories'].");this.closest(&#39;.task &#39;).remove();'>X</button>
                                    </div>";
                            }
                        } 
                    ?>
            ...
            <div class="column" id="in-progress">
                ...
                <div class="task-container" id="processando">
                    <?php                        
                        foreach ($tarefas_stories as $key => $tarefa) {
                            if(strtolower($tarefa['status']) == 'processando'){
                                echo "<div class='task' id='".$tarefa['id_tarefa_stories']."' draggable='true' ondragstart='dragStart(event)' ondragend='dragEnd(event)'>
                                        <ul>
                                            <li class='task-detail'>Cliente: {$tarefa['nome']}</li>
                                            <li class='task-detail'>{$tarefa['descricao']}</li>
            ...
            <div class="column" id="done">
                ...
                <div class="task-container" id="finalizado">
                    <?php                       
                       foreach ($tarefas_stories as $key => $tarefa) {
                            if(strtolower($tarefa['status']) == 'finalizado'){
                                echo "<div class='task' id='".$tarefa['id_tarefa_stories']."' draggable='true' ondragstart='dragStart(event)' ondragend='dragEnd(event)'>
                                        <ul>
                                            <li class='task-detail'>Cliente: {$tarefa['nome']}</li>
                                            <li class='task-detail'>{$tarefa['descricao']}</li>
    ...
    <script src="tarefa_stories.js"></script>
</body>
</html>
