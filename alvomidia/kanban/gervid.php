...
$sql = "SELECT t.*, c.nome FROM tarefas_video t 
...
<body>
    ...
    <div class="app-container">
        <h1>Gerenciador de Tarefas de Vídeo</h1>
        ...
        <div class="kanban">
            <div class="column" id="todo">
                ...
                <div class="task-container" id="pendente">
                    <?php
                        foreach ($tarefas_video as $key => $tarefa) {
                            if(strtolower($tarefa['status']) == 'pendente'){
                                echo "<div class='task' id='".$tarefa['id_tarefa_video']."' draggable='true' ondragstart='dragStart(event)' ondragend='dragEnd(event)'>
                                        <ul>
                                        ...
                                        <button class='delete-btn' onclick='deletaTarefa(".$tarefa['id_tarefa_video'].");this.closest(&#39;.task &#39;).remove();'>X</button>
                                    </div>";
                            }
                        } 
                    ?>
    ...
    <script src="tarefa_video.js"></script>
</body>
</html>
