...
$sql = "SELECT t.*, c.nome FROM tarefas t 
...
<body>
                    ...
                    <?php
                        foreach ($tarefas as $key => $tarefa) {
                            if(strtolower($tarefa['status']) == 'pendente'){
                                echo "<div class='task' id='".$tarefa['id_tarefa']."' draggable='true' ondragstart='dragStart(event)' ondragend='dragEnd(event)'>
                                        <ul>
                                        ...
                                        <button class='delete-btn' onclick='deletaTarefa(".$tarefa['id_tarefa'].");this.closest(&#39;.task &#39;).remove();'>X</button>
                                    </div>";
                            }
                        } 
                    ?>
    ...
    <script src="tarefa_feed.js"></script>
</body>
</html>
