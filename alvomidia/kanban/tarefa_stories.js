// Variável para armazenar a tarefa arrastada
...
function criaTarefa(tarefa, data, hora, cliente){
    ...
    fetch('database/criatarefastories.php', {
        method: 'POST',
        headers: {
...
function atualizaTarefa(idTarefa, idColuna){
    ...
    fetch('database/alterartarefastories.php', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json'
        },
...
function deletaTarefa(id){
    fetch('database/deletatarefastories.php', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json'
        },
